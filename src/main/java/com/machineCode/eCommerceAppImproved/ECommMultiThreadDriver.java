...
import com.machineCode.eCommerceAppImproved.*;
...
import static com.machineCode.eCommerceAppImproved.model.ProductType.GIFT;
...
public class ECommMultiThreadDriver {
    public static void main(String[] args) {
        ...
        Product product = new Product("p1", "product1",14, address,GIFT.name(), 34.0);
        productService.addProduct(product);

        Product product1 = new Product("p2", "product2", 7,address,GIFT.name(), 45.0);
